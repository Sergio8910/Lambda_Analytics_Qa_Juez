...
import pytest
from evaluation.control_plane import db
...
class TestDatabaseModule:
    ...
    def test_table_indexes(self, test_db_session):
        ...
        from evaluation.control_plane.models import Job, Tenant
...
class TestDatabaseModels:
    ...
    def test_job_model_defaults(self, test_db_session, sample_tenant):
        ...
        from evaluation.control_plane.models import Job, JobStatusEnum, JobKindEnum
    ...
    def test_relationships(self, test_db_session, sample_tenant):
        ...
        from evaluation.control_plane.models import Job, JobKindEnum
