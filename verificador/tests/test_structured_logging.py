"""Tests para verificador.utils.structured_logging."""
...
def _emit(message: str, *, extra: dict | None = None, level: str = "info") -> None:
    ...
    log = logging.getLogger("verificador.test.structured_logging")
    log.propagate = True
...
def test_format_json_via_env(monkeypatch, capsys):
    ...
    assert payload["logger"] == "verificador.test.structured_logging"
