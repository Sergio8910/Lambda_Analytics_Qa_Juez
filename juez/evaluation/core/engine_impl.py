...
from .task_success_rubric import build_task_success_rubric
...
class JudgeEngine:
    ...
    def _run_task_success(self, metric: MetricSpec, ctx: Dict[str, Any]) -> MetricResult:
        ...
        criteria, steps, evaluation_mode = build_task_success_rubric(
            ctx.get("expected_behavior", ""), case_tags
        )
        is_adversarial = evaluation_mode == "adversarial"
