from juez.evaluation.utils.text_normalization import repair_text, repair_recursive
...
def test_report_no_mojibake():
    ...
    from juez.evaluation.utils.text_normalization import repair_recursive as _rr
