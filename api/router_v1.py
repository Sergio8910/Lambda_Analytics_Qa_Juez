...
from api.runner import run_elevenlabs_single, run_n8n_single, run_pipeline
...
def health() -> Dict[str, Any]:
    ...
    try:
        from api.runner import _load_module  # type: ignore
    ...
    try:
        import evaluation.contra_agente.generator  # noqa: F401
