...
try:
    ...
    from evaluation.contra_agente.adapters.n8n import N8nAdapter as _N8nAdapter
...
def ejecutar_contra_agente(
    ...
    if HAS_RICH:
        with Progress(SpinnerColumn(), TextColumn("[cyan]Ejecutando conversaciones..."), console=console, transient=True) as p:
            ...
            batch_result = _ca_ejecutar_batch(batch, _adapter_factory, evaluator, openai_key=openai_key)
    else:
...
def _seleccionar_modo_analisis() -> str:
    ...
    if HAS_RICH:
        ...
        console.print("  [bold][2][/bold] Validacion  — Solo verifica conectividad y estructura del flujo (rapido)\n")
        ...
        print("  [2] Validacion — Solo conectividad y estructura (rapido)")
...
def main() -> None:
    ...
    argv_pos = [a for a in sys.argv[1:] if not a.startswith("--")]
    ...
    _artef: Dict[str, Any] = {}
    try:
        from evaluation.artifact import run_artifact_eval
