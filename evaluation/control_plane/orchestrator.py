...
from evaluation.control_plane.models import Job, JobKindEnum, JobStatusEnum
from evaluation.control_plane.registry import JobRegistry
from evaluation.execution.tasks import (
    run_functional_eval,
    run_rag_eval,
    run_security_eval,
...
class JobOrchestrator:
    ...
    def get_job_status(self, job_id: UUID) -> Dict[str, Any]:
        ...
        from evaluation.execution.celery_app import app as celery_app
